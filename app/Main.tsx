    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="relative left-1/2 mt-100 w-screen -translate-x-1/2 bg-red-950 sm:mt-110 md:mt-120 xl:mt-140">
          <div className="mx-auto flex max-w-3xl flex-col items-start justify-between px-4 pb-15 sm:px-6 xl:max-w-5xl xl:px-0">
            <Image
              ...
              width={400}
              title="Me at Stoos"
              className="relative z-2 -mt-90 h-auto w-full sm:-mt-100 sm:w-3/5 md:-mt-70 md:w-2/5 lg:-mt-110 lg:w-3/5 xl:-mt-120 xl:w-1/2"
            />
            <Link
              href="/about"
